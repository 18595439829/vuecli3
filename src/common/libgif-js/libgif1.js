...
export default class LibGif {
  constructor(opts) {
    ...
    let doText = function(text) {
      toolbar.innerHTML = text; // innerText? Escaping? Whatever.
      toolbar.style.visibility = "visible";
    };

    let setSizes = function(w, h) {
    ...
    let setFrameOffset = function(frame, offset) {
    ...
    let doShowProgress = function(pos, length, draw) {
    ...
    let doLoadError = function(originOfError) {
